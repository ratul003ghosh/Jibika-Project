...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($conflict_q->num_rows > 0) {
        ...
        if ($conn->query($sql)) {
            ...
            // Notify Candidate
            $conn->query("INSERT INTO notifications (user_id, job_id, title_en, message_en, type, link) VALUES ($candidate_id, $job_id, 'Interview Proposed', 'The employer has proposed an interview for $app_data[title]. Please review and accept.', 'info', 'jobseeker/application_tracking.php')");
